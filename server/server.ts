...
import { getTopPlayers, insertGameResults, getTotalPlayers } from "./db/queries";
...
const clientURI = process.env.CLIENT_URI?.trim() || "http://localhost:5173";
const allowedOrigins = [clientURI, "http://localhost:5173", "http://127.0.0.1:5173"];
